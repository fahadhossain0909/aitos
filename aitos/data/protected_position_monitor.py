...
def install_protected_position_monitor() -> None:
    ...
    original_trade=DataIngestionService.update_live_trade_symbols; original_kline=DataIngestionService.update_live_kline_symbols
    ...
    DataIngestionService.update_live_trade_symbols=trade; DataIngestionService.update_live_kline_symbols=kline
