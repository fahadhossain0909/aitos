...
CREATE TABLE IF NOT EXISTS prop_rule_snapshots (
    ...
    provider LowCardinality(String),
    account_id String,
    daily_loss_limit Nullable(Float64),
    max_drawdown Nullable(Float64),
    daily_loss_uses_equity UInt8,
    max_drawdown_uses_equity UInt8,
    api_allowed UInt8,
    automation_allowed UInt8,
    news_trading_allowed UInt8,
    overnight_allowed UInt8,
    weekend_allowed UInt8,
    max_order_notional Nullable(Float64)
) ENGINE = MergeTree()
