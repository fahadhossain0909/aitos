...
The module is deliberately execution-agnostic: callers provide the primary and
hedge equity/price paths and trade intervals. This keeps hedge attribution
separate from the live trading decision logic.
"""
...
def expectancy(pnls: Sequence[float]) -> float:
    """Mean realized PnL per completed trade."""
