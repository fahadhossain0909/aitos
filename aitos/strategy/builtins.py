...
from .contracts import CapitalRequest, ExecutionIntent, Strategy, StrategyContext, StrategyFamily, StrategyResult
...
class HedgeStrategy(Strategy):
    ...
    def evaluate(self, context: StrategyContext) -> StrategyResult:
        ...
        return StrategyResult(
            self.strategy_id, self.family,
            (ExecutionIntent(self.hedge_instrument, side, qty, reduce_only=False,
                             strategy_id=self.strategy_id, hedge_group="portfolio-delta",
...
class RegimeRouterStrategy(Strategy):
    ...
    def evaluate(self, context: StrategyContext) -> StrategyResult:
        ...
        return StrategyResult(
            self.strategy_id, self.family,
            diagnostics={"regime": context.global_regime,
