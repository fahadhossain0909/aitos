...
def build_score_breakdown(
    ...
    Component scores are expected on the scanner's 0-10 scale. The normalized
    result is kept on the existing 0-100 scale and is intentionally not used to
    alter the scanner's threshold or scoring semantics.
    """
    contributions = [
        ScoreContribution(
            name=name,
