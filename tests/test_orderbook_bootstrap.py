...
def test_bootstrap_discards_diffs_already_covered_by_rest_snapshot():
    ...
    # After seed(), book is immediately initialized and ready
...
def test_bootstrap_accepts_first_diff_that_bridges_rest_snapshot():
    ...
    # Bridging update: first_update_id=101 > last_update_id=100, previous_update_id=100 matches
    result = book.apply(_update(101, 102, previous=100))
