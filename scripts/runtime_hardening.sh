...
# maxmemory setting across deployments.
...
# Live-path CPU ceilings are intentionally not applied here. Redis and the
# paper-trading runtime must be allowed to burst during the forensic CPU
# quota experiment. The compose file is likewise free of cpus limits for
# these services.
...
# live-cursor reset. No CPU ceiling is re-applied after recreation.
